...
"MSWin32-x64-multi-thread-6.3" or
	die "Errno architecture (MSWin32-x64-multi-thread-6.3) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
